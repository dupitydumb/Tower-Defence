...
public class InventoryMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        inventoryManager.OnInventoryChanged += InitializedInventoryPanel;
    }
    ...
    void InitializedCraftingPanel()
    {
        ...
        foreach (ItemsData item in itemsData)
        {
            if (item.isCraftable)
            {
                ...
                itemCard.transform.GetChild(1).gameObject.SetActive(false);
            }
        }
    }
    ...
    void InitializedInventoryPanel()
    {
        ...
        foreach (InventoryItem item in inventoryManager.items)
        {
            ...
            itemCard.GetComponent<ItemsCard>().isInventoryCard = true;
        }
    }
}
